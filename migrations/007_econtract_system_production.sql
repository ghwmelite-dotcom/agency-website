-- Migration: E-Contract System (Production)
-- Created: 2025-01-10
...
-- Insert default contract templates (only if they don't exist)
INSERT OR IGNORE INTO contract_templates (id, name, description, category, template_content, placeholders, default_terms) VALUES (
  1,
  ...
  <section class="contract-section">
    ...
    <ol>
      ...
      <li><strong>Revisions:</strong> The project includes up to 3 rounds of revisions.</li>
      ...
      <li><strong>Support:</strong> Developer will provide 30 days of post-launch support.</li>
    </ol>
  </section>
...
INSERT OR IGNORE INTO contract_templates (id, name, description, category, template_content, placeholders, default_terms) VALUES (
  ...
  <section class="contract-section">
    <h2>Services</h2>
    <p>Consultant agrees to provide professional consulting services as described below:</p>
    <p>{{project_description}}</p>
  </section>
  ...
  <section class="contract-section">
    ...
    <ol>
      ...
      <li>Client will receive regular progress updates.</li>
      <li>Either party may terminate with 30 days notice.</li>
      <li>All work product remains confidential.</li>
    </ol>
  </section>
</div>',
...
INSERT OR IGNORE INTO contract_templates (id, name, description, category, template_content, placeholders, default_terms) VALUES (
  ...
  <section class="contract-section">
    <h2>Subscription</h2>
    <p><strong>Monthly Fee:</strong> {{total_amount}} {{currency}}</p>
    <p><strong>Start Date:</strong> {{start_date}}</p>
    <p>{{payment_terms}}</p>
  </section>
  ...
  <section class="contract-section">
    ...
    <ol>
      ...
      <li>Additional hours beyond the monthly limit will be billed separately.</li>
    </ol>
  </section>
</div>',
